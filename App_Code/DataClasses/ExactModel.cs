...
/// <summary>
/// Summary description for ExactModel
/// </summary>
public class ExactModel
{
    ...
    public object model_engine_bore_in { get; set; }
    public object model_engine_stroke_in { get; set; }
    ...
    public object model_top_speed_mph { get; set; }
    public string model_weight_lbs { get; set; }
    public object model_length_in { get; set; }
    public object model_width_in { get; set; }
    public object model_height_in { get; set; }
    public object model_wheelbase_in { get; set; }
    ...
    public List<object> ExtColors { get; set; }
    public List<object> IntColors { get; set; }
}