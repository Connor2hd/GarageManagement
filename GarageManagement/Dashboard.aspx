    ...
    <div class="row dash-row">
        ...
        <div class="col-xl-4">
            <div class="stats stats-success ">
                <h3 class="stats-title">Gross Revenue </h3>
                <div class="stats-content">
                    <div class="stats-icon">
                        <i class="fas fa-money-bill-wave"></i>
                    </div>
                    <div class="stats-data">
                        <div class="stats-number"><asp:Label runat="server" ID="lblGrossRevenue"></asp:Label></div>
                        <div class="stats-change">
                            <span class="stats-percentage"><asp:Label runat="server" ID="lblGrossRevenueDifference"></asp:Label></span>
                            <span class="stats-timeframe">from last month</span>
                        </div>
                    </div>
                </div>
